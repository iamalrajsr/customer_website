      ...
      <div classNameName="">
        <div className="container-fluid my- ">
          ...
          <footer class="bg-dark py-5">
            <div class="container py-5">
              <div class="row py-">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0"><img src="img/logo.png" alt="" width="180" class="mb-3" />
                  <p class="font-italic text-white text-">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                ...
                <div class="col-lg-4 col-md-6 mb-lg-0">
                  ...
                  <p class="text-white mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At itaque temporibus.</p>
            ...
            <div class="bg-light py-2 bg-info">
